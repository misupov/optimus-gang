...
<div class="row user-details-row" v-bind:style="background">
    <span style="flex: 1; display: flex; justify-content: flex-end; align-items: center; width: 50%">
    ...
    <span style="flex:1; display: flex; justify-content: flex-start; align-items: center; width: 50%">
        <span>
